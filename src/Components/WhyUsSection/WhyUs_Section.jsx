  ...
  return (
    <div>
     <div className="last-product-section">
        <h2 className="last-product-h2">لماذا متجر مليون فكرة هو وجهتك الأولى لتسوق ؟</h2>
        ...
        <div className="last-product-products-content">
            <div className="last-product-content-box">
                <div className="last-icon-box">
                    <FaCircleCheck id='circle-check' className='last-product-icon'/>
                </div>
    
                <div className="last-text-content">
                    <span className="last-text-content-span">جودة مضمونة</span>
                    <span className="last-text-content-sub-span">رضاكم هو أولويتنا</span>
                </div>
            </div>
            ...
            <div className="last-product-content-box">
                ...
                <div className="last-text-content">
                    ...
                    <span className="last-text-content-sub-span">لكل مكان في المملكة</span>
                </div>
            </div>
            ...
            <div className="last-product-content-box">
                ...
                <div className="last-text-content">
                    ...
                    <span className="last-text-content-sub-span">مدفوعاتك آمنة ١٠٠٪</span>
                </div>
            </div>
         </div>
     </div>
